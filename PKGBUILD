...
source=("https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-${pkgver}.tar".{xz,sign}
        ...
        "0020-ntfs.patch::${_patches_url}/ntfs3-patches-v2/0001-ntfs3-patches.patch"
)
...
b2sums=('88e4c32cf196662a6a24e72b978019d6f8881a8523918029f4229a995c5fd957a5e01f42de9f53c7980df7e3de5ea6b069cc2c5f93852e615fe8fe78a1b131c6'
        ...
        '84fcff8ecc1d05704735bd6135c501ca2a2dc91b8a3ef6b9a724d533239302d9047eaaf949662d167e97c646b05bd7baa8ccc0ef74acc5d4f4166e3800862ec9'
)
...
_package() {
  pkgdesc="The ${pkgbase/linux/Linux} kernel and modules with the ck1 , uksm etc... patchesset featuring MuQSS CPU scheduler"
